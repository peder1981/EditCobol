...
class PlanilhaRegistros:
    ...
    def executar(self):
        ...
        def _(event):
            ...
            # Importante: primeiro sair da aplicação, depois processar a ação
        ...
        # Processar ações após sair da aplicação
        if self.acao_executada == "excluir":
            self.excluir_selecionados()
        elif self.acao_executada == "manter":
